...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    public boolean add(Integer integer) {
        if(this.contains(integer)==false) differentElements++;
        return super.add(integer);
    }

    @Override
    public void add(int index, Integer element) {
        if(this.contains(element)==false)differentElements++;
    ...
    public boolean addAll(int index, Collection<? extends Integer> c) {
        for(Integer i:c)
        { if(this.contains(i)==false) differentElements++;
    ...
    public Integer remove(int index) {
       int x= Collections.frequency(this,get(index));

        if(x==1) differentElements--;
    ...
    public boolean remove(Object o) {
        int x= Collections.frequency(this,o);
